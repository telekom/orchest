package io.telekom.orchest.configuration.encryption;
...
public class MongoEncryptionConfiguration {
  ...
  /**
   * Creates the object mapper used for hashing string fields before encryption.
   *
   * @return a new string hashing object mapper
   */
  @Bean
  ...
  /**
   * Creates the listener that encrypts/decrypts process instance fields on Mongo read/write.
   *
   * @param cipherService the cipher service
   * @param stringHashingObjectMapper the hashing mapper
   * @return the process instance crypto listener
   */
  @Bean
  ...
  /**
   * Creates the listener that encrypts/decrypts decision instance fields on Mongo read/write.
   *
   * @param cipherService the cipher service
   * @return the decision instance crypto listener
   */
  @Bean
