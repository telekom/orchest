...
/**
 * Result of scrolling process instances by offset range {@code [from, to)} over the filtered,
 * sorted sequence.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class ProcessInstanceScrollDTO {

  private List<ProcessInstanceDTO> content;
