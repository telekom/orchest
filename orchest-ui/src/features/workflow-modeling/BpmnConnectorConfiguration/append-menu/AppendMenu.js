...
import {
  scrollIntoView,
  sanitizeImageUrl
} from '@/features/workflow-modeling/BpmnConnectorConfiguration/utils';

import {
  ChangeMenuResult
} from '@/features/workflow-modeling/BpmnConnectorConfiguration/common';

import clsx from 'clsx';

import {
  CREATE_OPTIONS
} from '@/features/workflow-modeling/BpmnConnectorConfiguration/create-menu/CreateOptions';
