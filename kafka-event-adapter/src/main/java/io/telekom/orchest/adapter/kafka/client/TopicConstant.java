...
public class TopicConstant {
  ...
  /** Topic for process resume events. */
  public static final String PROCESS_RESUME_EVENT_TOPIC = ORCHEST_PREFIX + "PROCESS_RESUME_EVENT";

  /** Topic for dynamic process invocation events. */
  public static final String DYNAMIC_PROCESS_INVOCATION_EVENT_TOPIC =
      ORCHEST_PREFIX + "DYNAMIC_PROCESS_INVOCATION_EVENT";
  ...
  public static final String SERVER_WORKER_EVENT_TOPIC =
      ORCHEST_PREFIX + "SERVER_WORKER_EVENT_TOPIC";
  ...
  public static final String SERVER_INCIDENT_EVENT = ORCHEST_PREFIX + "SERVER_INCIDENT_EVENT_TOPIC";

  public static final String SERVER_INCIDENT_RESOLUTION_EVENT =
      ORCHEST_PREFIX + "SERVER_INCIDENT_RESOLUTION_EVENT_TOPIC";

  /** Topic for connector task dispatch events consumed by the connector service. */
  public static final String CONNECTOR_TASK_EVENT_TOPIC = ORCHEST_PREFIX + "CONNECTOR_TASK_EVENT";
}
